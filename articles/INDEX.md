# Index — Articles publiés

Chaque entrée : `[fichier](fichier.md) — mot clé principal → angle en une ligne`.
À maintenir à chaque nouvel article intégré.
...
## Marche en laisse & obéissance

- [chien-qui-tire-en-laisse.md](chien-qui-tire-en-laisse.md) — Causes (besoins non comblés, tempérament), méthode marche, matériel.

## Fugue

- [chien-qui-fugue.md](chien-qui-fugue.md) — Fugue vs manque de rappel, combler les besoins, contre les colliers/clôtures électriques.

## Chiot & adolescence

- [adolescence-chien.md](adolescence-chien.md) — Démystification « crise d'ado » : hormones vs manquements éducatifs.
